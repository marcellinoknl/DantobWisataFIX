                  ...
                  <div class="card-body">
                     ...
                     <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('login') }}"enctype="multipart/form-data">
                        ...
                        <div class=" mb-3">
                           ...
                           <input id="email" placeholder="Masukkan Email atau User Name Anda"type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                        </div>
