...
@foreach ($atraksiheaders as $atraksiheader)
<div class="hero-wrap" style="background-image: url({{asset('images/atraksiheader/'. $atraksiheader->file_foto)}}); width: 100%; height:75%; ">
    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-12 ftco-animate">
               <h1 class="mb-4" style="text-align: center;">{{$atraksiheader->tagline}}</h1>
               @endforeach
            </div>
        </div>
    </div>
...
<div class="bg0 m-t-23 p-b-140">
    <div class="container">
        ...
        @if( auth()->user()->role ==3) 
        <a href='/ubah-atraksi/{{$dep->id}}'><button type="button" class="btn btn-outline-success float-lg-right" data-mdb-ripple-color="dark" >Ubah Deskripsi</button></a>
        @else
        @endif
        <p class="caption" style=" color:black;">
            {!!$dep->deskripsi!!}
