...
<div class="hero-wrap js-fullheight" style="background-image: url({{asset('images/fasil/'. $fasil->file_foto)}}); width: 100%; height:75%; ">
    <div class="overlay" style="width:100%;height: 100%;"></div>
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
            <div class="sharethis-sticky-share-buttons"></div>
            <div class="col-md-12 ftco-animate">
                <h1 class="mb-4" style="text-align: center;"> {{$fasil->tagline}}</h1>
                @endforeach
            </div>
        </div>
    </div>
