...
<div class="bg0 m-t-23 p-b-140">
    ...
    <div class="container">
        ...
        <br>
        <a href="/objek-wisata/detail2/like/{{$objek_wisata_detail->id_obj_wisata}}"class ="text-danger" style="font-weight: bold; "><i class="fa fa-heart"></i> {{$like}} Suka</a>
        &nbsp;&nbsp;&nbsp;
        <a href="#" style="color: black; font-weight: bold; "><i class="fa fa-eye"></i>  {{$objek_wisata_detail->views}} Kali dikunjungi</a>
        {{-- <i class="fa fa-eye" style="color: black; font-weight: bold;">  {{$objek_wisata_detail->views}} kali dikunjungi</i> --}}
