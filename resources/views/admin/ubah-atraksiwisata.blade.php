            ...
            <section id="main-content">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{route('atraksiwisata.ubah',$update->atraksi_id)}}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                        <div class="mb-3 row">
                                            <label class="col-sm-3 col-form-label">Judul Atraksi </label>
                                            <div class="col-sm-9">

                                                <input type="text"  id="judulatrkasi" name="judul" class="form-control @error('judul') is-invalid @enderror" value="{{$update->judul}}">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
