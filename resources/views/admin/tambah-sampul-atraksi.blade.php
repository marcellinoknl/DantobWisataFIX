            ...
            <section id="main-content">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{route('formsampulatraksi.store')}}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="mb-3 row">
                                        <label class="col-sm-3 col-form-label">Nama Sampul  </label>
                                        <div class="col-sm-9">
                                            <input type="text" id="namasampul" name="nama_sampul" class="form-control @error('nama_sampul') is-invalid @enderror">
                                            @error('nama_sampul')
