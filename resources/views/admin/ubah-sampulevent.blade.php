                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Ubah Kategori Event</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <section id="main-content">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('formsampulevent.ubah', $update->id) }}" method="post"
                                    ...
                                    <button type="button" class="btn btn-danger"
                                        onclick="window.location.href='/sampul-event'"><i class="ti-close"></i>
                                        Batal</button>
