   ...
   <div class="col-lg-8 p-r-0 title-margin-right">
      <div class="page-header">
         <div class="page-title">
            <h1>KELOLA HEADER DESA WISATA</span></h1>
         </div>
      </div>
   </div>
   <!-- /# column -->
         ...
         <div class="col-lg-12">
            <section id="main-content">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="card">
                        <h1>HEADER DESA WISATA</h1>
                        <form action="{{route('dewi.ubah',$update->id)}}" method="post" enctype="multipart/form-data">
                           {{ csrf_field() }}
                           <div class="mb-3 row">
                          ...
                          <div class="mb-3 row">
                           ...
                           <div class="col-sm-9">
                               <img class="img-preview img-fluid mb-3 col-sm-5" alt="" src="{{url('images/dewiheader/'.$update->file_foto)}}">
