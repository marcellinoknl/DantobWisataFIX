            ...
            <section id="main-content">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('user.ubah', $update->id) }}" method="post"
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input type="text"  id="name" name="name"
                                                class="form-control @error('name') is-invalid @enderror" value="{{$update->name}}">
                                                @error('name')
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input type="email" disabled  id="email" name="email"
                                                class="form-control @error('email') is-invalid @enderror" value="{{$update->email}}">
                                                @error('email')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <select  id="role" name="role"
                                                ...
                                                <option value="{{$userpluses->role_id}}" @if( $userpluses->role_id == $update->role ) selected @endif>{{$userpluses->nama_role}}</option>
                                                @endforeach
                                            </select>
                                            @error('nama_sampul')
                                                <div class="invalid-feedback">
