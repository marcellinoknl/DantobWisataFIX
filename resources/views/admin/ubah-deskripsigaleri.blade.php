                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Kelola Deskripsi Galeri</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <section id="main-content">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="{{route('deskripsigaleri.ubah',$update->id)}}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="mb-3 row">
                                    ...
                                    <br><br>
                                    <button type="button" class="btn btn-danger" onclick="window.location.href='/galeriwisata'"><i class="ti-close"></i> Batal</button>
