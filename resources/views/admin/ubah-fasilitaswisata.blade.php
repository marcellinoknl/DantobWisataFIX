            ...
            <section id="main-content">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{route('fasilitaswisata.ubah',$update->id_fasilitas)}}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                        <div class="mb-3 row">
                                            <label class="col-sm-3 col-form-label">Nama Fasilitas</label>
                                            <div class="col-sm-9">
                                                <input type="text" required="required" id="nama_fasilitas" name="nama_fasilitas" class="form-control" value="{{$update->nama_fasilitas}}">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label class="col-sm-3 col-form-label">Gambar</label>
                                            <div class="col-sm-9">
                                                <img class="img-preview img-fluid mb-3 col-sm-5" alt="" src="{{url('images/fasilitas/'.$update->file_foto)}}">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input type="text"  id="lokasi" name="lokasi" class="form-control @error('lokasi') is-invalid @enderror" value="{{$update->lokasi}}">
                                                @error('lokasi')
                                        ...
                                        <div class ="mb-3 row">
                                            <textarea type="text" required="required" id="deskripsi" name="deskripsi" height="300px" class="form-control" >{{$update->deskripsi}}</textarea>
                                        </div>
                                        <br><br>    
