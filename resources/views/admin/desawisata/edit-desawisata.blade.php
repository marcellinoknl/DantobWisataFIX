            ...
            <section id="main-content">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{route('desawisata.ubah',$update->id)}}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                        <div class="mb-3 row">
                                            <label class="col-sm-3 col-form-label">Nama Desa</label>
                                            <div class="col-sm-9">
                                                <input type="text" id="nama_desa" name="nama_desa" class="form-control  @error('nama_desa') is-invalid @enderror" value="{{$update->nama_desa}}">
                                                @error('nama_desa')
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <select   id="id_obj_wisata_kabupaten" name="nama_kabupaten" class="form-control @error('nama_kabupaten') is-invalid @enderror"  >
                                                    ...
                                                    <option value="{{$kab->id_obj_wisata_kabupaten}}" @if( $kab->id_obj_wisata_kabupaten == $update->id_obj_wisata_kabupaten ) selected @endif>{{$kab->nama_kab}}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <img class="img-preview img-fluid mb-3 col-sm-5" alt="" src="{{url('images/desawisata/'.$update->file_foto)}}">
                                        ...
                                        <br><br>    
                                        <button type="button" class="btn btn-danger" onclick="window.location.href='/keloladesawisata'"><i class="ti-close"></i> Batal</button>
