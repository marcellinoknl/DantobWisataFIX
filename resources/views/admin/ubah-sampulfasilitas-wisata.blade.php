                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Kelola Sampul Fasilitas</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <form action="{{route('formsampulfasilitas.ubah',$update->id)}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="namasampul" name="nama_sampul" class="form-control  @error('nama_sampul') is-invalid @enderror" value="{{$update->nama_sampul}}">
                                            @error('nama_sampul')
