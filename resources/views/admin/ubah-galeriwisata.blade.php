                            ...
                            <div class="card-body">
                                <form action="{{route('galeriwisata.ubah',$update->id_galeri)}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" required="required" id="judul" name="judul" class="form-control" value="{{$update->judul}}">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label class="col-sm-3 col-form-label">Gambar </label>
                                        <div class="col-sm-9">
                                            <img class="img-preview img-fluid mb-3 col-sm-5" alt="" src="{{url('images/galeriwisata/'.$update->file_foto)}}">
