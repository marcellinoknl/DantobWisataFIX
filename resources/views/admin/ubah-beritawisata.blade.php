                                ...
                                <form action="{{route('beritawisata.ubah',$update->id_berita)}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input type="text" required="required" id="judul_berita" name="judul" class="form-control" value="{{$update->judul_berita}}">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <textarea type="text" required="required" id="isi_berita" name="isi_berita" deskripsi" height="300px" class="form-control">{{$update->isi_berita}}</textarea>
