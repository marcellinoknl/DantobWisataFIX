                            ...
                            <div class="card-body">
                                <form action="{{route('kabupaten.ubah',$update->id_obj_wisata_kabupaten)}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"  id="nama_kab" name="nama_kab"  value="{{$update->nama_kab}}" class="form-control @error('nama_kab') is-invalid @enderror">
                                            @error('nama_kab')
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <img class="img-preview img-fluid mb-3 col-sm-5" alt="" src="{{url('images/objekwisata/'.$update->file_foto)}}" value="{{$update->file_foto}}">
